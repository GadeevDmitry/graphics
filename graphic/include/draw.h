...
inline void draw_vec2d(const vec2d &vec_beg, const vec2d &vec_main, const coord_system &sys, sf::RenderTarget &wnd, const sf::Color &col);
inline void draw_line (const vec2d &vec_beg, const vec2d &vec_main, const coord_system &sys, sf::RenderTarget &wnd, const sf::Color &col);

void        draw_hollow_rectangle(const rectangle_t &pix_rect, sf::RenderTarget &wnd, const sf::Color &outline_col);
void        draw_filled_rectangle(const rectangle_t &pix_rect, sf::RenderTarget &wnd, const sf::Color &outline_col, const sf::Color &fill_col);
inline void draw_filled_rectangle(const rectangle_t &pix_rect, sf::RenderTarget &wnd, const sf::Color &fill_col);

void        draw_filled_circle(const circle_t &pix_circle, sf::RenderTarget &wnd, const sf::Color &outline_col, const sf::Color &fill_col);
inline void draw_filled_circle(const circle_t &pix_circle, sf::RenderTarget &wnd, const sf::Color &fill_col);

inline void draw_segment(const segment_t &pix_seg, sf::RenderTarget &wnd, const sf::Color &col);
...
inline void draw_vec2d(const vec2d &vec_beg, const vec2d &vec_main, const coord_system &sys,
                       sf::RenderTarget &wnd, const sf::Color &col)
{
