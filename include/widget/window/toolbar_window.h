...
// member functions
public:
    explicit toolbar_window_t(window_controller_t &controller, tool_manager_t &tool_manager,                               const color_t &color = Red_theme);
    explicit toolbar_window_t(window_controller_t &controller, tool_manager_t &tool_manager, const rectangle_t &enclosing, const color_t &color = Red_theme);
